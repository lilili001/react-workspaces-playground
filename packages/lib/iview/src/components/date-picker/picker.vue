    ...
    >
        <div ref="reference" :class="[prefixCls + '-rel']">
            <slot>
                ...
                >
                    <Icon @click="handleIconClick" :type="arrowType" :custom="customArrowType" :size="arrowSize" slot="suffix" style="font-size: 14px"/>
                </i-input>
            </slot>
        </div>
        ...
        computed: {
            ...
            arrowType () {
                ...
                if (this.type === 'time' || this.type === 'timerange') {
                    type = 'iconfont iconfont iconriqi';
                ...
                if (this.showClose) type = 'md-close';
                return type;
            },
