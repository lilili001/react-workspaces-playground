<template>
    <div :class="wrapClasses">
        <template v-if="type !== 'textarea'">
            ...
            <i class="ivu-icon" :class="['ivu-icon-md-close', prefixCls + '-icon', prefixCls + '-icon-clear' , prefixCls + '-icon-normal']" v-if="clearable && currentValue && !itemDisabled" @click="handleClear"></i>
