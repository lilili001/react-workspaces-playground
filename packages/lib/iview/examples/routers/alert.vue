<template>
    <div>
        ...
        <Alert type="info" show-icon closable>用于内容中，模块中等信息提示。</Alert>
        <Alert type="success" show-icon closable>成功提示文案</Alert>
        <Alert type="warning" show-icon closable>警告提示文案，用于信息提醒！</Alert>
        <Alert type="error" show-icon closable>错误警示，故障等提示。</Alert>
        <Alert show-icon>
            消息提示文案
