...
<!--    </div>-->
    <div>
        <h4>主按钮</h4>
        <Button type="primary" size="large" disabled>正面操作</Button>
        <Button type="default" size="large">负面操作</Button>
        <Button type="disabled" size="large" disabled>禁用</Button>
        <br/><br/>
        <Button type="primary" size="small">正面</Button>
        <Button type="default" size="small">负面</Button>
        <Button type="disabled" size="small" disabled>禁用</Button>
        <br/><br/>
        <h4>带icon按钮</h4>
        <Button type="primary" size="small" icon="ios-download-outline">正面</Button>
        <Button type="default" size="small" icon="ios-download-outline">负面</Button>
        <Button type="disabled" size="small" icon="ios-download-outline"disabled>禁用</Button>
        <br/><br/>
        <h4>弱化操作按钮</h4>
        <Button type="info" size="small" icon="ios-download-outline" ghost>上传营业执照部分免填写</Button>
        <Button type="info" size="small" ghost>修改产品车型</Button>
    </div>
</template>
<script>
    export default {
